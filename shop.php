...
<head>
    ...
    <title>Tastypresso &#8211; Taste What Matters</title>
                            ...
                            <div class="menu_main_wrap">
                                ...
                                <nav class="menu_main_nav_area">
                                    <ul id="menu_main" class="menu_main_nav">
                                        <li class="menu-item"><a href="index.php" class="colorizer">HOME</a></li>
                                        ...
                                        <li class="menu-item"><a href="about.php" class="colorizer">ABOUT</a></li>
                                        <li class="menu-item"><a href="shop.php" class="colorizer">PRODUCTS</a></li>
                                        ...
                                        <li class="menu-item"><a href="contacts.php" class="colorizer">CONTACT</a></li>
                                    </ul>
                                </nav>
                            ...
                            <ul class="products">
                                <li class="product has-post-thumbnail column-1_2 first sale">
                                    ...
                                    <div class="post_item_wrap">
                                        ...
                                        <div class="post_content">
                                            <h3>
                                                <a href="single-product.html">Produc 1</a>
                                            </h3>
                                            <!-- <span class="price">
                                                <del>
                                ...
                                <li class="product has-post-thumbnail column-1_2 last">
                                    ...
                                    <div class="post_item_wrap">
                                        ...
                                        <div class="post_content">
                                            <h3>
                                                <a href="single-product.html">Product 2</a>
                                            </h3>
                                            <!-- <span class="price">
                                                <span class="woocommerce-Price-amount amount">
                                ...
                                <li class="product has-post-thumbnail column-1_2 first sale">
                                    ...
                                    <div class="post_item_wrap">
                                        ...
                                        <div class="post_content">
                                            <h3>
                                                <a href="single-product.html">Product 3</a>
                                            </h3>
                                            <!-- <span class="price">
                                                <del>
                                                    <span class="woocommerce-Price-amount amount">
                                ...
                                <li class="product has-post-thumbnail column-1_2 last">
                                    ...
                                    <div class="post_item_wrap">
                                        ...
                                        <div class="post_content">
                                            <h3>
                                                <a href="single-product.html">Product 4</a>
                                            </h3>
                                            <!-- <span class="price">
                                                <span class="woocommerce-Price-amount amount">
                                ...
                                <li class="product has-post-thumbnail column-1_2 last">
                                    ...
                                    <div class="post_item_wrap">
                                        ...
                                        <div class="post_content">
                                            <h3>
                                                <a href="single-product.html">Product 5</a>
                                            </h3>
                                            <!-- <span class="price">
                                                <span class="woocommerce-Price-amount amount">
                                                    <span class="woocommerce-Price-currencySymbol">&#36;</span>14.00
