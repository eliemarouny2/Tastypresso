            ...
            <ul>
                ...
                <li data-index="rs-2" data-transition="fade" data-slotamount="default" data-easein="default" data-easeout="default" data-masterspeed="300" data-rotate="0" data-saveperformance="off" data-title="Slide" data-description="">
                    ...
                    <div class="tp-caption tp-resizeme" id="slide-2-layer-13" data-x="103" data-y="489" data-width="['none','none','none','none']" data-height="['none','none','none','none']" data-transform_idle="o:1;" data-transform_in="opacity:0;s:300;e:Power2.easeInOut;" data-transform_out="opacity:0;s:300;s:300;" data-start="500" data-responsive_offset="on">
                        <img src="images/slide2b.png" alt="" width="221" height="161" data-ww="321px" data-hh="261px" data-no-retina>
                    </div>
                    <div class="tp-caption tp-resizeme rs-parallaxlevel-1" id="slide-2-layer-14" data-x="443" data-y="244" data-width="['none','none','none','none']" data-height="['none','none','none','none']" data-transform_idle="o:1;" data-transform_in="opacity:0;s:300;e:Power2.easeInOut;" data-transform_out="opacity:0;s:300;s:300;" data-start="500" data-responsive_offset="on">
                        <img src="images/slide2.png" alt="" width="560" height="525" data-ww="516px" data-hh="485px" data-no-retina>
                    </div>
                ...
                <li data-index="rs-1" data-transition="fade" data-slotamount="default" data-easein="default" data-easeout="default" data-masterspeed="300" data-rotate="0" data-saveperformance="off" data-title="Slide" data-description="">
                    ...
                    <div class="tp-caption tp-resizeme rs-parallaxlevel-2" id="slide-1-layer-14" data-x="570" data-y="328" data-width="['none','none','none','none']" data-height="['none','none','none','none']" data-transform_idle="o:1;" data-transform_in="opacity:0;s:300;e:Power2.easeInOut;" data-transform_out="opacity:0;s:300;s:300;" data-start="500" data-responsive_offset="on">
                        <img src="images/slide3.png" alt="" width="417" height="439" data-ww="397px" data-hh="439px" data-no-retina>
                    </div>
                </li>
            </ul>
                        ...
                        <div class="wpb_column vc_column_container vc_col-sm-12">
                            <div class="vc_column-inner ">
                                <div class="wpb_wrapper">
                                    <h2 class="sc_title sc_title_regular sc_align_center margin_top_tiny margin_bottom_small" data-animation="animated fadeInUp normal">Welcome to Tastypresso
                                    </h2>
...
<br>Tastypresso invested in adapting the same rich aromatic sensation into capsules, inspired by our patrimony and maintaining an identical experience, we proudly poured coffee, tea, cardamom and saffron into a variety of premium products 
<br>Rich taste, a modern twist and an entire trip to our arabic culture stimulated us to set the benchmark for high quality and trust
                                                    ...
                                                    <div class="columns_wrap sc_columns columns_nofluid sc_columns_count_2 margin_bottom_huge">
                                                        ...
                                                        <div class="column-1_2 sc_column_item">
                                                            <div class="sc_section margin_bottom_huge brown" data-animation="animated fadeInUp normal">
                                                                <div class="sc_section_inner">
                                                                    <h4 class="sc_title sc_title_big margin_top_huge margin_bottom_null">
                                                                        The<br />
                                                                        Experience</h4> <br>
                                                                    ...
                                                                    <div class="wpb_text_column wpb_content_element vc_custom_1455040756358">
                                                                        <div class="wpb_wrapper">
                                                                            <p class="margin_small">
                                                                                As the wise man once said, there is no right time for Coffee! Weither you are a morning person,
																		     an afternoon gathering enthusiast or a late night passionate, Tastypresso promises to become your best friend! <br>
																				Not only sharing your best moments but also offering you the benefits of karak tea, cardamom and saffron!<br>
																				Since not every taste can write a story, taste what matters! 
                                                                            </p>
                                                                        </div>
                                                                    </div>
                                                                    <a href="#" class="sc_button sc_button_square sc_button_style_style sc_button_size_small margin_top_small margin_bottom_small"></a>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                    ...
                                    <section class="post_content">
                                        <div class="vc_row wpb_row vc_row-fluid">
                                            <div class="wpb_column vc_column_container vc_col-sm-12">
                                                <div class="vc_column-inner ">
                                                    <div class="wpb_wrapper">
                                                        <h2 class="sc_title sc_title_regular sc_align_center margin_bottom_small">Blended with love</h2>
                                                        <div class="sc_section aligncenter">
                                                            <div class="sc_section_inner">
                                                                <div class="wpb_text_column wpb_content_element ">
                                                                    <div class="wpb_wrapper">
                                                                        <p>
                                                                            Try our variety of products and explore our kept promises!
                                                                        </p>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        ...
                                                        <div id="sc_tabs_730" class="sc_tabs sc_tabs_style_2 margin_top_large" data-active="0">
                                                            <ul class="sc_tabs_titles">
                                                                <li class="sc_tabs_title">
                                                                    <a href="#sc_tab_131-2" class="theme_button" id="sc_tab_131-2_tab">Products List</a>
                                                                </li>
                                                                        ...
                                                                        <div class="sc_columns columns_wrap">
                                                                            <div class="column-1_2 column_padding_bottom">
                                                                                <div id="sc_menuitems_347_1" class="sc_menuitems_item sc_menuitems_item_1" data-url="menu-item-1.html">
                                                                                    ...
                                                                                    <div class="sc_menuitem_title">
                                                                                        <a class="show_popup_menuitem" href="#">Teamix</a>
                                                                                    </div>
                                                                            ...
                                                                            <div class="column-1_2 column_padding_bottom">
                                                                                <div id="sc_menuitems_347_2" class="sc_menuitems_item sc_menuitems_item_2" data-url="menu-item-2.html">
                                                                                    ...
                                                                                    <div class="sc_menuitem_title">
                                                                                        <a class="show_popup_menuitem" href="#">Karak Cardamom Tea</a>
                                                                                    </div>
                                                                                    <div class="sc_menuitem_description">Duis autem vel eum iriure dolor in hendrerit in vulputate velitesse molestie...</div>
                                                                                </div>
                                                                            </div>
                                                                            <div class="column-1_2 column_padding_bottom">
                                                                                <div id="sc_menuitems_347_3" class="sc_menuitems_item sc_menuitems_item_3" data-url="menu-item-3.html">
                                                                                    ...
                                                                                    <div class="sc_menuitem_title">
                                                                                        <a class="show_popup_menuitem" href="#">Arabic Coffee</a>
                                                                                    </div>
                                                                            ...
                                                                            <div class="column-1_2 column_padding_bottom">
                                                                                <div id="sc_menuitems_347_4" class="sc_menuitems_item sc_menuitems_item_4" data-url="menu-item-4.html">
                                                                                    ...
                                                                                    <div class="sc_menuitem_title">
                                                                                        <a class="show_popup_menuitem" href="#">Royal Coffee</a>
                                                                                    </div>
                                                                            ...
                                                                            <div class="column-1_2 column_padding_bottom">
                                                                                <div id="sc_menuitems_347_5" class="sc_menuitems_item sc_menuitems_item_5" data-url="menu-item-5.html">
                                                                                    ...
                                                                                    <div class="sc_menuitem_title">
                                                                                        <a class="show_popup_menuitem" href="#">Karak Tea with Saffron</a>
                                                                                    </div>
                                                                                    <div class="sc_menuitem_description">Autem vel eum iriure dolor in hendrerit in vulputate velitesse molestie...</div>
                                                                                </div>
                                                                            </div>
                                                ...
                                                <ul>
                                                    ...
                                                    <li data-index="rs-4" data-transition="fade" data-slotamount="default" data-easein="default" data-easeout="default" data-masterspeed="300" data-thumb="" data-rotate="0" data-saveperformance="off" data-title="Slide" data-description="">
                                                        ...
                                                        <div class="tp-caption Hotcoffee-style-9 tp-resizeme" id="slide-4-layer-3" data-x="645" data-y="454" data-width="['auto']" data-height="['auto']" data-visibility="['on','on','on','off']" data-transform_idle="o:1;" data-transform_in="opacity:0;s:500;e:Power2.easeInOut;" data-transform_out="opacity:0;s:500;s:500;" data-start="500" data-splitin="none" data-splitout="none" data-responsive_offset="on">
                                                            Inhale the delightful coffee smellthat fills bahrain streets<br />
                    ...
                    <div class="vc_row-full-width"> <h1> FAQ </h1></div>
                       <dl class="faq">
                        <dt>
